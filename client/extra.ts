...
export type { buildProps, ComponentEvent, ComponentEventData } from "./widgets/main/Component";
...
export { Ref, ref, typeref, onComponent, componentEvents } from "./widgets/main/Component";
