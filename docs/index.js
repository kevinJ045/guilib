...
var start = function() {
  ...
  if (typeof HomePage.title === "function")
    document.title = HomePage.title(buildProps({ page: made0 }));
  if (Array.isArray(HomePage.links)) {
    HomePage.links.forEach((url) => {
  ...
  if (Array.isArray(HomePage.scripts)) {
    HomePage.scripts.forEach((url) => {
      let script = document.createElement("script");
      script.src = url;
      document.head.appendChild(script);
    });
  ...
  window.loadFunction = () => {
    ...
    if (typeof HomePage.beforeBuildStart == "function")
      HomePage.beforeBuildStart(buildProps());
    let page0 = new HomePage;
    page0._beforeInit();
    page0.initState(buildProps());
    let page1 = new layout_default;
    page1._beforeInit();
    page1.initState(buildProps());
    if (window.lastPage && HomePage.inheritState !== false)
