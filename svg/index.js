...
class SVGPath extends Widget_default {
...
class SVGBare extends Widget_default {
  constructor(options7) {
    super(mergeOptions({
      class: "",
      _setters: ["path"]
...
class SVG extends SVGBare {
  ...
  static fromXML(xml) {
    ...
    let svg = findEl(svgWidget.id).at(0);
...
class SVGCircle extends Widget_default {
  constructor(options7) {
    super(mergeOptions({
      element: { name: "circle" },
      class: "",
...
class SVGRect extends Widget_default {
  constructor(options7) {
    super(mergeOptions({
      element: { name: "rect" },
      class: "",
