...
// client/components/HtmlElements.ts
class WebkitWidget extends Widget_default {
  constructor(options5 = {}) {
    super(options5);
  }
}

class Video extends WebkitWidget {
  constructor(options5 = {}) {
    let attributes = ["name", "type", "contenteditable", "controls", "src"];
    if (!options5.attr)
      options5.attr = {};
    for (let i in options5) {
      if (attributes.indexOf(i) > -1) {
        if (!options5.attr)
          options5.attr = {};
        options5.attr[i] = options5[i];
        delete options5[i];
      }
    }
    super({
...
class Table extends WebkitWidget {
  constructor(options5 = {}) {
...
class Style3 extends WebkitWidget {
  constructor(options5 = {}) {
...
class Span extends WebkitWidget {
  constructor(options5 = {}) {
    let attributes = ["name", "type", "contenteditable"];
    if (!options5.attr)
      options5.attr = {};
...
class Link extends WebkitWidget {
  constructor(options5 = {}) {
...
class Image extends WebkitWidget {
  constructor(options5 = {}) {
    let attributes = ["name", "type", "contenteditable"];
    if (!options5.attr)
      options5.attr = {};
...
class Canvas extends WebkitWidget {
  constructor(options5 = {}) {
...
class Button extends WebkitWidget {
  constructor(options5 = {}) {
...
class Audio extends WebkitWidget {
  constructor(options5 = {}) {
    let attributes = ["name", "type", "contenteditable", "controls", "src"];
    if (!options5.attr)
      options5.attr = {};
